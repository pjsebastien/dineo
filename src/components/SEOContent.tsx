          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                Mafate, Cilaos et Salazie, offrent des panoramas à couper le souffle. Les <Link to="/randonnees-reunion" className="text-blue-600 hover:text-blue-800 font-medium">randonnées guidées</Link>{' '}
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Découvrez toutes nos <Link to="/activites-famille-reunion" className="text-blue-600 hover:text-blue-800 font-medium">activités à faire à la Réunion</Link>{' '}
